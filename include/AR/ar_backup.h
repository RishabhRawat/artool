...
*/
int arDetectMarker( ARUint8 *dataPtr, ARUint8 *threshptr, int thresh,
...
*/
ARInt16 *arLabeling( ARUint8 *image, ARUint8 *threshptr, int thresh,
...
//Later Additions by Rishabh
void arCreateThresh(ARUint8 *image,ARUint8 *threshptr,int *thresh,int xmax,int ymax);
