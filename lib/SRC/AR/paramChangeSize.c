...
int arParamChangeSize( ARParam *source, int xsize, int ysize, ARParam *newparam )
{
	...
	newparam->mat[0][0] = 500;
	newparam->mat[1][1] = 560;
	

	newparam->mat[0][2] = xsize/2;
        newparam->mat[1][2] = ysize/2;

    newparam->dist_factor[0] = 0;//source->dist_factor[0] * scale;
    newparam->dist_factor[1] = 0;//source->dist_factor[1] * scale;
    newparam->dist_factor[2] = 0;//source->dist_factor[2] / (scale*scale);
    newparam->dist_factor[3] = 1;//source->dist_factor[3];
